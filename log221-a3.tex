...
\section{}
In light of the cut elimination theorem, we may freely use the cut rule since every instance of it can be removed after the fact; additionally, we freely use derived rules to make derivations shorter.
